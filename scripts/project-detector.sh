...
detect_languages() {
    ...
    PROJECT_ANALYSIS[languages]=$(IFS=','; echo "${detected_languages[*]}")
...
detect_package_managers() {
    ...
    PROJECT_ANALYSIS[package_managers]=$(IFS=','; echo "${package_managers[*]}")
    PROJECT_ANALYSIS[build_tools]=$(IFS=','; echo "${build_tools[*]}")
}
...
detect_frameworks() {
    ...
    PROJECT_ANALYSIS[frameworks]=$(IFS=','; echo "${frameworks[*]}")
}
...
analyze_repository() {
    ...
    PROJECT_ANALYSIS[project_files]=$(IFS=','; echo "${project_files[*]}")
...
generate_recommendations() {
    ...
    PROJECT_ANALYSIS[recommendations]=$(IFS='|'; echo "${recommendations[*]}")
}
