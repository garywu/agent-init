...
hero:
  ...
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/yourusername/agent-init
      icon: external
      variant: minimal
---
...
- [Report issues](https://github.com/yourusername/agent-init/issues)
- [Submit pull requests](https://github.com/yourusername/agent-init/pulls)
- [Join discussions](https://github.com/yourusername/agent-init/discussions)
